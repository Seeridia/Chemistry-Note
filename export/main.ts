...
for (let dirname of content) {
  ...
  if (existsSync(path.join(process.execPath, `..`, `../${dirname}/images`)))
    copySync(path.join(process.execPath, `..`, `../${dirname}/images`), path.join(process.execPath, `..`, `./tmp/${dirname}/images/`))
